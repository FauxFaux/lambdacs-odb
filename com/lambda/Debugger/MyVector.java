...
public class MyVector extends Vector {
	...
	super(c);
	//        elementCount = c.size();
	//	for (int i = 0; i < elementCount; i++) D.vectorChange(0, this, i, elementData[i]);
    ...
    //    public synchronized boolean removeElement(Object obj) { CALLS removeElementAt()
	...
	for (int i = 0; i < numMoved; i++) removeElementAt(fromIndex);
    }
